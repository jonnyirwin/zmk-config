...
#define _TOP_L(p)   p##LT5 p##LT4 p##LT3 p##LT2 p##LT1 p##LT0
#define _TOP_R(p)   p##RT0 p##RT1 p##RT2 p##RT3 p##RT4 p##RT5
#define _HOME_L(p)  p##LM5 p##LM4 p##LM3 p##LM2 p##LM1 p##LM0
#define _HOME_R(p)  p##RM0 p##RM1 p##RM2 p##RM3 p##RM4 p##RM5
#define _BOT_L(p)   p##LB5 p##LB4 p##LB3 p##LB2 p##LB1 p##LB0
#define _BOT_R(p)   p##RB0 p##RB1 p##RB2 p##RB3 p##RB4 p##RB5
#define _THUMB(p)   p##LH2 p##LH1 p##LH0 p##RH0 p##RH1 p##RH2
...
#define LAYER_SYS   MAKE_LAYER(SYS_)
#define LAYER_MOUSE MAKE_LAYER(MOUSE_)
